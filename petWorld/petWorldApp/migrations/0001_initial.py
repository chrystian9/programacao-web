    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='petWorldApp.address')),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ManyToManyField(related_name='products', to='petWorldApp.category')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payment', to='petWorldApp.customer')),
                ('delivery_address', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='petWorldApp.address')),
                ('payment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='petWorldApp.payment')),
                ('products', models.ManyToManyField(related_name='orders', to='petWorldApp.product')),
            ],
        ),
    ]
